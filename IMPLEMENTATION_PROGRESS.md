...
| **Thai Translation Patch (HSK1 & HSK2)** | Maintenance & Bug Fixes | `In Progress` | 46% | **Aug 4 update:** Upgraded 6 new lessons (`hsk1_day7`, `day9`, `day10`, `day11`, `day13`, `day14`) to `"llm"` Thai. Total HSK1 lessons locked on LLM Thai reached **12 lessons**. `QuotaExceededError` verified on `hsk1_day12` daily limit hit. 14 HSK1 + 17 HSK2 lessons remain for future quota runs. |
