...
| **Thai Translation Patch (HSK1 & HSK2)** | Maintenance & Bug Fixes | `In Progress` | 85% | **Aug 5 update:** Upgraded 10 new lessons to `"llm"` Thai (including rescuing `hsk1_day8` and `hsk1_day12`). Total HSK1 lessons locked on LLM Thai reached **22 lessons** (out of 26). Clean `QuotaExceededError` stop triggered on `hsk1_day25`. 2 fallback + 2 untouched HSK1 lessons and 17 HSK2 lessons remain for future quota runs. |
...
| **HSK1 Thai Translation Rollout (25/26 LLM Locked)** | Maintenance & Bug Fixes | `Complete` | 96% | Aug 5: Upgraded 25 out of 26 HSK 1 lessons (`hsk1_day1` through `day23`, `day25`, `day26`) to high-quality `"llm"` Thai translations in `patched_lessons_state.json` and Turso DB. Only 1 lesson (`hsk1_day24`) remains on `"fallback"`. |
